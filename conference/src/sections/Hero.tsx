...
const Hero: FC = () => {
  return (
    <section className="relative min-h-screen w-full max-w-full overflow-hidden bg-[#171512] text-white">
      <Image
      ...
      <div className="relative z-10 mx-auto flex min-h-screen w-full max-w-[1510px] flex-col justify-end px-4 pb-14 pt-32 sm:px-8 md:pb-20 lg:px-14 lg:pt-40">
        <div className="grid items-end gap-10 lg:grid-cols-[minmax(0,760px)_1fr]">
          <div className="max-w-[760px] pb-10 lg:pb-24">
            ...
            <h1 className="max-w-full break-words font-sfProDisplayBold text-[clamp(3rem,15vw,5.5rem)] font-black leading-[0.96] tracking-normal text-[#f7f4ec] md:text-[7rem] lg:text-[6.9rem] xl:text-[8.7rem]">
              Unlock Your
            ...
            <div className="mt-9 flex w-full flex-col gap-4 sm:flex-row">
              ...
              <Link href="#contact" className="w-full sm:w-auto">
                <Button
                  variant="outline"
                  className="h-14 w-full min-w-0 justify-center border-white/30 bg-transparent px-6 text-base font-bold normal-case text-white outline-none hover:border-white/60 hover:bg-white/10 sm:w-auto sm:min-w-[190px] md:h-[68px] md:text-xl"
                >
                  Get in Touch
                </Button>
              </Link>
